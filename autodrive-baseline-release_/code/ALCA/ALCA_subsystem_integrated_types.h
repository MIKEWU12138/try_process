/*
 * File: ALCA_subsystem_integrated_types.h
 *
...
#ifndef RTW_HEADER_ALCA_subsystem_integrated_types_h_
#define RTW_HEADER_ALCA_subsystem_integrated_types_h_
#include "rtwtypes.h"
...
typedef uint8_T EnumDCSN_autodrive_control_mode;/* 0 = AUTODRIVE_PASIV
                                                   1 = AUTODRIVE_ACTIVATING
                                                   2 = AUTODRIVE_ACTIVATED */

#define AUTODRIVE_PASIV                ((EnumDCSN_autodrive_control_mode)0) /* Default value */
#define AUTODRIVE_ACTIVATING           ((EnumDCSN_autodrive_control_mode)1)
#define AUTODRIVE_ACTIVATED            ((EnumDCSN_autodrive_control_mode)2)
#endif
...
typedef uint8_T EnumDCSN_stop_reason;
...
#define STOP_FOR_STOP_SIGN             ((EnumDCSN_stop_reason)3)
#define STOP_FOR_CROSSWALK             ((EnumDCSN_stop_reason)4)
#define STOP_FOR_KEEP_CLEAR            ((EnumDCSN_stop_reason)5)
#endif
...
#ifndef DEFINED_TYPEDEF_FOR_ALCA_DcsnInfo_
#define DEFINED_TYPEDEF_FOR_ALCA_DcsnInfo_

typedef struct
{
  boolean_T alca_enable;
  boolean_T change_lane_req;
  EnumDCSN_driving_direction change_lane_req_side;
  boolean_T change_lane_cancel;
  EnumDCSN_change_lane_reason change_lane_reason;
  EnumDCSN_change_lane_cancel_reason change_lane_cancel_reason;
}
ALCA_DcsnInfo;
...
#ifndef DEFINED_TYPEDEF_FOR_ALCA_VehState_
#define DEFINED_TYPEDEF_FOR_ALCA_VehState_

typedef struct
{
  real32_T veh_speed;
  real32_T veh_acceleration;
  real32_T veh_curvature;
  real32_T veh_vx;
  real32_T veh_vy;
}
ALCA_VehState;
...
#ifndef DEFINED_TYPEDEF_FOR_ALCA_MPFU_Info_
#define DEFINED_TYPEDEF_FOR_ALCA_MPFU_Info_

typedef struct
{
  int8_T ego_lane_index;
  boolean_T has_ego_lane;
  int8_T left_lane_marker_index;
  int8_T right_lane_marker_index;
  boolean_T has_left_lane_marker;
  boolean_T has_right_lane_marker;
  int8_T target_lane_from_dcsn_index;
...
#ifndef DEFINED_TYPEDEF_FOR_ALCA_CAN_Bus_
#define DEFINED_TYPEDEF_FOR_ALCA_CAN_Bus_
...
#ifndef DEFINED_TYPEDEF_FOR_EnumALCA_fault_type_
#define DEFINED_TYPEDEF_FOR_EnumALCA_fault_type_

typedef uint8_T EnumALCA_fault_type;   /* 1:ALCA_fault_type_EGMO_notReceived
                                          2:ALCA_fault_type_MPFU_notReceived
                                          4:ALCA_fault_type_OBFU_notReceived
                                          8:ALCA_fault_type_CAN_notReceived */

#define ALCA_fault_type_EGMO_notReceived ((EnumALCA_fault_type)1)
#define ALCA_fault_type_MPFU_notReceived ((EnumALCA_fault_type)2) /* Default value */
#define ALCA_fault_type_OBFU_notReceived ((EnumALCA_fault_type)4)
#define ALCA_fault_type_CAN_notReceived ((EnumALCA_fault_type)8)
#endif
#endif                                 /* RTW_HEADER_ALCA_subsystem_integrated_types_h_ */
