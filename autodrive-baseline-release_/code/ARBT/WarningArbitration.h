...
#ifndef RTW_HEADER_WarningArbitration_h_
#define RTW_HEADER_WarningArbitration_h_
...
extern void ARBT_subsyst_WarningArbitration(void);

#endif                                 /* RTW_HEADER_WarningArbitration_h_ */
