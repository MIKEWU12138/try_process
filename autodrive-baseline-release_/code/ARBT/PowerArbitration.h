...
#ifndef RTW_HEADER_PowerArbitration_h_
#define RTW_HEADER_PowerArbitration_h_
...
extern void ARBT_subsystem_PowerArbitration(void);

#endif                                 /* RTW_HEADER_PowerArbitration_h_ */
