/*
 * File: AEBS_subsystem_integrated_types.h
 *
...
#ifndef RTW_HEADER_AEBS_subsystem_integrated_types_h_
#define RTW_HEADER_AEBS_subsystem_integrated_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_EnumAEBS_Error_
#define DEFINED_TYPEDEF_FOR_EnumAEBS_Error_

typedef uint8_T EnumAEBS_Error;

#define AEBS_ErrorStatus_ReadOBFUFailed ((EnumAEBS_Error)1)      /* Default value */
#define AEBS_ErrorStatus_ReadEGMOFailed ((EnumAEBS_Error)2)
#define AEBS_ESP_failed                ((EnumAEBS_Error)4)
#endif

#ifndef DEFINED_TYPEDEF_FOR_AEBS_CAN_Bus_
#define DEFINED_TYPEDEF_FOR_AEBS_CAN_Bus_
...
typedef struct
{
  ...
  real32_T FedBck_YawRate;
}
AEBS_CAN_Bus;

#endif

#ifndef DEFINED_TYPEDEF_FOR_AEBS_Obs_VIP_info_Bus_
#define DEFINED_TYPEDEF_FOR_AEBS_Obs_VIP_info_Bus_

typedef struct
{
  boolean_T has_obs_VIP;
  uint8_T obs_index_VIP;
  real32_T obs_rp_VIP;
  uint8_T obs_position_state_VIP;
  real32_T obs_ttc_VIP;
  real32_T obs_delta_dis_VIP;
  real32_T obs_delta_speed_VIP;
  int32_T obs_id_VIP;
  int8_T obs_type_VIP;
  real32_T obs_v_lateral_VIP;
  real32_T obs_v_long_VIP;
  real32_T obs_acc_lateral_VIP;
  real32_T obs_acc_long_VIP;
  real32_T obs_NP_x_VIP;
  real32_T obs_NP_y_VIP;
  real32_T obs_heading_VIP;
  real32_T obs_length_VIP;
  real32_T obs_width_VIP;
  real32_T obs_dis_long_VIP;
  real32_T obs_dis_lateral_VIP;
  int8_T obs_position_zone_VIP;
  int8_T obs_motion_status_VIP;
  uint8_T obs_confidence_VIP;
}
AEBS_Obs_VIP_info_Bus;

#endif

#ifndef DEFINED_TYPEDEF_FOR_EnumAEBS_TurnType_
#define DEFINED_TYPEDEF_FOR_EnumAEBS_TurnType_

typedef uint8_T EnumAEBS_TurnType;

#define AEBS_Straight                  ((EnumAEBS_TurnType)1)    /* Default value */
#define AEBS_LeftTurn                  ((EnumAEBS_TurnType)2)
#define AEBS_RightTurn                 ((EnumAEBS_TurnType)3)
#define AEBS_TurnInvalid               ((EnumAEBS_TurnType)4)
#endif
#endif                                 /* RTW_HEADER_AEBS_subsystem_integrated_types_h_ */
