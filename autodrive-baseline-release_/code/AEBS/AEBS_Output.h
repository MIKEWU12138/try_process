...
#ifndef RTW_HEADER_AEBS_Output_h_
#define RTW_HEADER_AEBS_Output_h_
...
extern void AEBS_subsyste_AEBS_Output_Const(void);
extern void AEBS_subsystem_inte_AEBS_Output(void);

#endif                                 /* RTW_HEADER_AEBS_Output_h_ */
