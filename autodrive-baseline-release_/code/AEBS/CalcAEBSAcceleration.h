...
#ifndef RTW_HEADER_CalcAEBSAcceleration_h_
#define RTW_HEADER_CalcAEBSAcceleration_h_
#include <math.h>
...
extern void AEBS_subsy_CalcAEBSAcceleration(void);

#endif                                 /* RTW_HEADER_CalcAEBSAcceleration_h_ */
