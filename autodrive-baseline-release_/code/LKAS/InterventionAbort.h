...
#ifndef RTW_HEADER_InterventionAbort_h_
#define RTW_HEADER_InterventionAbort_h_
...
extern void LKAS_subsyste_InterventionAbort(void);

#endif                                 /* RTW_HEADER_InterventionAbort_h_ */
