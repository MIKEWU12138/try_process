...
#ifndef RTW_HEADER_InterventionCompletion_h_
#define RTW_HEADER_InterventionCompletion_h_
...
extern void LKAS_sub_InterventionCompletion(void);

#endif                                 /* RTW_HEADER_InterventionCompletion_h_ */
