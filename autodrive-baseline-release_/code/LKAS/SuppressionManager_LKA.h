...
#ifndef RTW_HEADER_SuppressionManager_LKA_h_
#define RTW_HEADER_SuppressionManager_LKA_h_
...
extern void LKAS_sub_SuppressionManager_LKA(void);

#endif                                 /* RTW_HEADER_SuppressionManager_LKA_h_ */
