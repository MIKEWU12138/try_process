/*
 * File: LKAS_subsystem_integrated_types.h
 *
...
#ifndef RTW_HEADER_LKAS_subsystem_integrated_types_h_
#define RTW_HEADER_LKAS_subsystem_integrated_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_LKAS_RoadEnbl_
#define DEFINED_TYPEDEF_FOR_LKAS_RoadEnbl_

typedef struct
{
  boolean_T RoadEnblLe;
  boolean_T RoadEnblRi;
  boolean_T RoadEnbl;
}
LKAS_RoadEnbl;
...
#ifndef DEFINED_TYPEDEF_FOR_EnumLKAS_CtrlRefTypVcc_
#define DEFINED_TYPEDEF_FOR_EnumLKAS_CtrlRefTypVcc_

typedef uint8_T EnumLKAS_CtrlRefTypVcc;

#define LKAS_NoRef                     ((EnumLKAS_CtrlRefTypVcc)0) /* Default value */
#define LKAS_LaneMkrToClsLe            ((EnumLKAS_CtrlRefTypVcc)1)
#define LKAS_LaneMkrToClsRi            ((EnumLKAS_CtrlRefTypVcc)2)
#endif

#ifndef DEFINED_TYPEDEF_FOR_LKAS_VehStates_
#define DEFINED_TYPEDEF_FOR_LKAS_VehStates_

typedef struct
{
  EnumLKAS_IntvSide IntvSideReq_sLKA;
  real32_T Vlat_sLKA;
  real32_T L_DistToCross_sLKA;
  EnumLKAS_CtrlRefTypVcc CtrlRefReq_sLKA;
  real32_T L_ExtraMargin_sLKA;
  real32_T A_ALatRelLaneMkr_sLKA;
  real32_T A_ALatRelLaneMkrLe;
  real32_T A_ALatRelLaneMkrRi;
  real32_T Vlong_sLKA;
}
LKAS_VehStates;
...
#ifndef DEFINED_TYPEDEF_FOR_EnumLKAS_LaneMkrQly_
#define DEFINED_TYPEDEF_FOR_EnumLKAS_LaneMkrQly_

typedef uint8_T EnumLKAS_LaneMkrQly;

#define VldForEnag                     ((EnumLKAS_LaneMkrQly)1)  /* Default value */
#define NotVld                         ((EnumLKAS_LaneMkrQly)0)
#endif

#ifndef DEFINED_TYPEDEF_FOR_LKAS_SFSignals_
#define DEFINED_TYPEDEF_FOR_LKAS_SFSignals_

typedef struct
{
  boolean_T QualDrpLeft;
  boolean_T QualDrpRight;
  real32_T VLatleft;
  real32_T L_DisToCrossLeft;
  real32_T OffstLe_sLKA;
  real32_T Cr_RoadLeft;
  real32_T Le_Length;
  EnumLKAS_LaneMkrQly B_LineLeftOK;
  real32_T VLatRight;
  real32_T L_DistToCrossRight;
  real32_T OffstRi_sLKA;
  real32_T Cr_RoadRight;
  real32_T Ri_Length;
  EnumLKAS_LaneMkrQly B_LineRightOK;
  real32_T Heading;
  real32_T SupPosnConCoeff;
  real32_T SupPosnFirstCoeff;
  real32_T SupPosnSecCoeff;
  real32_T SupPosnThrdCoeff;
  real32_T Cr_Road;
  real32_T L_LaneWidth;
...
#ifndef DEFINED_TYPEDEF_FOR_LKAS_TrajData_
#define DEFINED_TYPEDEF_FOR_LKAS_TrajData_

typedef struct
{
  boolean_T ZeroTrajectoryFound_sLKA;
  boolean_T TrajectoryFound_sLKA;
  real32_T JerkNeeded_sLkA;
  real32_T EndOffset_sLKA;
  real32_T TimeNeeded_sLKA;
  real32_T LatAccNeeded_sLKA;
}
LKAS_TrajData;

#endif

#ifndef DEFINED_TYPEDEF_FOR_LKAS_Curv_
#define DEFINED_TYPEDEF_FOR_LKAS_Curv_

typedef struct
{
  boolean_T InnerCurvLe_sLKA;
  boolean_T InnerCurvRi_sLKA;
}
LKAS_Curv;

#endif

#ifndef DEFINED_TYPEDEF_FOR_LKAS_PathData_
#define DEFINED_TYPEDEF_FOR_LKAS_PathData_
...
#ifndef DEFINED_TYPEDEF_FOR_LKAS_InternalOutput_
#define DEFINED_TYPEDEF_FOR_LKAS_InternalOutput_

typedef struct
{
  real32_T T_AftIntvStart;
  EnumLKAS_IntvTyp IntvTyp_sLKA;
  EnumLKAS_CtrlRefTypVcc CtrlRef_sLKA;
  EnumLKAS_IntvSide IntvSide_sLKA;
  boolean_T IsIntvCompleted_sLKA;
}
LKAS_InternalOutput;

#endif

#ifndef DEFINED_TYPEDEF_FOR_LKAS_IntvMngr_
#define DEFINED_TYPEDEF_FOR_LKAS_IntvMngr_
...
#ifndef DEFINED_TYPEDEF_FOR_LKAS_TrgtValues_
#define DEFINED_TYPEDEF_FOR_LKAS_TrgtValues_

typedef struct
{
  real32_T OffstError;
  real32_T TrgtLaneOffst;
}
LKAS_TrgtValues;

#endif

#ifndef DEFINED_TYPEDEF_FOR_LKAS_EnblMngr_
#define DEFINED_TYPEDEF_FOR_LKAS_EnblMngr_

typedef struct
{
  boolean_T Enabled_sLKA;
}
LKAS_EnblMngr;

#endif

#ifndef DEFINED_TYPEDEF_FOR_LKAS_Abort_
#define DEFINED_TYPEDEF_FOR_LKAS_Abort_

typedef struct
{
  uint8_T AbortID_sLKA;
  boolean_T AbortIntv_sLKA;
  boolean_T DlyAftAbort_sLKA;
}
LKAS_Abort;

#endif

#ifndef DEFINED_TYPEDEF_FOR_LKAS_IntvCmpl_
#define DEFINED_TYPEDEF_FOR_LKAS_IntvCmpl_
...
#ifndef DEFINED_TYPEDEF_FOR_LKAS_Suppress_
#define DEFINED_TYPEDEF_FOR_LKAS_Suppress_

typedef struct
{
  boolean_T SuppLe_sLKA;
  boolean_T SuppRi_sLKA;
}
LKAS_Suppress;

#endif

#ifndef DEFINED_TYPEDEF_FOR_LKAS_Trig_
#define DEFINED_TYPEDEF_FOR_LKAS_Trig_

typedef struct
{
  boolean_T Activate_sLKA;
}
LKAS_Trig;

#endif

#ifndef DEFINED_TYPEDEF_FOR_EnumLKAS_SystemSt_
#define DEFINED_TYPEDEF_FOR_EnumLKAS_SystemSt_

typedef uint8_T EnumLKAS_SystemSt;

#define LKAS_Off                       ((EnumLKAS_SystemSt)0)    /* Default value */
#define LKAS_On                        ((EnumLKAS_SystemSt)1)
#endif

#ifndef DEFINED_TYPEDEF_FOR_EnumLKAS_OnStateSt_
#define DEFINED_TYPEDEF_FOR_EnumLKAS_OnStateSt_

typedef uint8_T EnumLKAS_OnStateSt;

#define LKAS_Enabling                  ((EnumLKAS_OnStateSt)0)   /* Default value */
#define LKAS_Standby                   ((EnumLKAS_OnStateSt)1)
#define LKAS_Active                    ((EnumLKAS_OnStateSt)2)
#define LKAS_Suppressed                ((EnumLKAS_OnStateSt)3)
#define LKAS_completed                 ((EnumLKAS_OnStateSt)4)
#define LKAS_aborted                   ((EnumLKAS_OnStateSt)5)
#endif

#ifndef DEFINED_TYPEDEF_FOR_LKAS_Parameters_
#define DEFINED_TYPEDEF_FOR_LKAS_Parameters_

typedef struct
{
  real32_T VehicleWheelBase;
  real32_T VehicleWidth;
}
LKAS_Parameters;

#endif
#endif                                 /* RTW_HEADER_LKAS_subsystem_integrated_types_h_ */
