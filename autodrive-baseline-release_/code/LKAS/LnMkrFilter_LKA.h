...
#ifndef RTW_HEADER_LnMkrFilter_LKA_h_
#define RTW_HEADER_LnMkrFilter_LKA_h_
...
extern void LKAS_subsystem__LnMkrFilter_LKA(void);

#endif                                 /* RTW_HEADER_LnMkrFilter_LKA_h_ */
