...
#ifndef RTW_HEADER_OutputManager_LKA_h_
#define RTW_HEADER_OutputManager_LKA_h_
...
extern void LKAS_subsyste_OutputManager_LKA(void);

#endif                                 /* RTW_HEADER_OutputManager_LKA_h_ */
