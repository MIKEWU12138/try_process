/*
 * File: DCSN_subsystem_integrated_types.h
 *
...
#ifndef RTW_HEADER_DCSN_subsystem_integrated_types_h_
#define RTW_HEADER_DCSN_subsystem_integrated_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_EnumDCSN_stop_request_mode_
#define DEFINED_TYPEDEF_FOR_EnumDCSN_stop_request_mode_

typedef uint8_T EnumDCSN_stop_request_mode;/* 0 NotEnabled
                                              1 WaitForValidStopLine
                                              2 CheckStopCond
                                              3 SendStopReqMpfuDis
                                              4 UpdateStopDis
                                              5 HoldForStopLineUpdate */

#define NotEnabled                     ((EnumDCSN_stop_request_mode)0) /* Default value */
#define WaitForValidStopLine           ((EnumDCSN_stop_request_mode)1)
#define CheckStopCond                  ((EnumDCSN_stop_request_mode)2)
#define SendStopReqMpfuDis             ((EnumDCSN_stop_request_mode)3)
#define UpdateStopDis                  ((EnumDCSN_stop_request_mode)4)
#define HoldForStopLineUpdate          ((EnumDCSN_stop_request_mode)5)
#endif
#endif                                 /* RTW_HEADER_DCSN_subsystem_integrated_types_h_ */
