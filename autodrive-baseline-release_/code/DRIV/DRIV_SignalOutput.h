...
#ifndef RTW_HEADER_DRIV_SignalOutput_h_
#define RTW_HEADER_DRIV_SignalOutput_h_
...
extern void CheckDRIV_SignalOutput(void);

#endif                                 /* RTW_HEADER_DRIV_SignalOutput_h_ */
