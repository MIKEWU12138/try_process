/*
 * File: LDWS_subsystem_integrated_types.h
 *
...
#ifndef RTW_HEADER_LDWS_subsystem_integrated_types_h_
#define RTW_HEADER_LDWS_subsystem_integrated_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_EnumLDWS_wrn_mgr_st_
#define DEFINED_TYPEDEF_FOR_EnumLDWS_wrn_mgr_st_

typedef uint8_T EnumLDWS_wrn_mgr_st;   /* 0=NotAvl;
                                          1=Avl;
                                          2=WarnLe;
                                          3=WarnRi;
                                          4=SuppLe;
...
#define Avl                            ((EnumLDWS_wrn_mgr_st)1)  /* Default value */
#define NotAvl                         ((EnumLDWS_wrn_mgr_st)0)
#define WarnLe                         ((EnumLDWS_wrn_mgr_st)2)
#define WarnRi                         ((EnumLDWS_wrn_mgr_st)3)
#define SuppLe                         ((EnumLDWS_wrn_mgr_st)4)
#define SuppRi                         ((EnumLDWS_wrn_mgr_st)5)
#endif
#endif                                 /* RTW_HEADER_LDWS_subsystem_integrated_types_h_ */
