...
#ifndef RTW_HEADER_EnablingManager_LDW_h_
#define RTW_HEADER_EnablingManager_LDW_h_
#include <math.h>
...
extern void LDWS_subsys_EnablingManager_LDW(void);

#endif                                 /* RTW_HEADER_EnablingManager_LDW_h_ */
