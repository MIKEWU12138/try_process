...
#ifndef RTW_HEADER_SuppressionManager_LDW_h_
#define RTW_HEADER_SuppressionManager_LDW_h_
...
extern void LDWS_sub_SuppressionManager_LDW(void);

#endif                                 /* RTW_HEADER_SuppressionManager_LDW_h_ */
