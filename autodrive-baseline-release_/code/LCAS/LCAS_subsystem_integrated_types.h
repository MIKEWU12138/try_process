/*
 * File: LCAS_subsystem_integrated_types.h
 *
...
#ifndef RTW_HEADER_LCAS_subsystem_integrated_types_h_
#define RTW_HEADER_LCAS_subsystem_integrated_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_EnumLCAS_warningArea_
#define DEFINED_TYPEDEF_FOR_EnumLCAS_warningArea_

typedef uint8_T EnumLCAS_warningArea;

#define WARNING_HLEVEL_AREA            ((EnumLCAS_warningArea)0) /* Default value */
#define WARNING_S_AREA                 ((EnumLCAS_warningArea)1)
#define WARNING_L_AREA                 ((EnumLCAS_warningArea)2)
#define MAY_WARNING_AREA               ((EnumLCAS_warningArea)3)
#define NO_WARNING_AREA                ((EnumLCAS_warningArea)4)
#endif

#ifndef DEFINED_TYPEDEF_FOR_LCAS_CVW_area_Bus_
#define DEFINED_TYPEDEF_FOR_LCAS_CVW_area_Bus_

typedef struct
{
  real32_T KfLCAS_d_CVZone_NearDis;
  real32_T KfLCAS_d_CVLargerZone_NearDis;
  real32_T KfLCAS_d_CVZone_FarDis;
  real32_T KfLCAS_d_CVLargerZone_FarDis;
  real32_T KfLCAS_d_CVZone_FrontDis;
  real32_T KfLCAS_d_CVLargerZone_FrontDis;
  real32_T KfLCAS_t_TTCThrshLowLevel;
  real32_T KfLCAS_t_TTCLargerThrsh_LowLevel;
}
LCAS_CVW_area_Bus;

#endif

#ifndef DEFINED_TYPEDEF_FOR_LCAS_EnbleCondBus_
#define DEFINED_TYPEDEF_FOR_LCAS_EnbleCondBus_

typedef struct
{
  boolean_T KbLCAS_Switch;
  real32_T KfLCAS_v_EnbleVehSpdThrshLo;
  real32_T KfLCAS_v_DisbleVehSpdThrshLo;
  real32_T KfLCAS_v_EnbleVehSpdThrshHi;
  real32_T KfLCAS_v_DisbleVehSpdThrshHi;
  real32_T KfLCAS_c_EnbleCurveThrshMax;
  real32_T KfLCAS_c_DisbleCurveThrshMax;
  real32_T KfLCAS_Ang_EnbleStrAngleThrshMax;
  real32_T KfLCAS_Ang_DisbleStrAngleThrshMax;
}
LCAS_EnbleCondBus;
...
typedef struct tag_RTM_LCAS_subsystem_integr_T RT_MODEL_LCAS_subsystem_integ_T;

#endif                                 /* RTW_HEADER_LCAS_subsystem_integrated_types_h_ */
