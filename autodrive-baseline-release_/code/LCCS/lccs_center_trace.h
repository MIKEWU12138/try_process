...
#ifndef RTW_HEADER_lccs_center_trace_h_
#define RTW_HEADER_lccs_center_trace_h_
#include <string.h>
...
extern void CalcLCCS_lane_center_discretize(void);

#endif                                 /* RTW_HEADER_lccs_center_trace_h_ */
